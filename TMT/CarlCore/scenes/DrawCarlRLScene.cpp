...
void cDrawCarlRLScene::RecordPhase(int agent_id, double& out_phase) const
{
	GetCarlRLScene()->RecordPhase(agent_id, out_phase);
}

void cDrawCarlRLScene::RecordMotionLabel(int agent_id, int& out_motion_label) const
{
	GetCarlRLScene()->RecordMotionLabel(agent_id, out_motion_label);
}
...
bool cDrawCarlRLScene::SwitchMotion(int agent_id, int target_motion, double target_phase)
{
	return GetCarlRLScene()->SwitchMotion(agent_id, target_motion, target_phase);
}
